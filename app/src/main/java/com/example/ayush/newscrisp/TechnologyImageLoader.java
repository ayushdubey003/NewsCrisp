...
class TechnologyImageLoader implements LoaderManager.LoaderCallbacks<List<News>> {
    ...
    public TechnologyImageLoader(List<News> news, NewsAdapter adapter, LoaderManager loaderManager, Context context, FragmentActivity activity, int id) {
        mContext = context;
        mAdapter = adapter;
