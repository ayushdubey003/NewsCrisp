...
class HealthImageLoader implements LoaderManager.LoaderCallbacks<List<News>> {
    ...
    public HealthImageLoader(List<News> news, NewsAdapter adapter, LoaderManager loaderManager, Context context, FragmentActivity activity, int id) {
        mContext = context;
        mAdapter = adapter;
