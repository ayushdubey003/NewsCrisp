...
class SportsImageLoader implements LoaderManager.LoaderCallbacks<List<News>> {
    ...
    public SportsImageLoader(List<News> news, NewsAdapter adapter, LoaderManager loaderManager, Context context, FragmentActivity activity, int id) {
        mContext = context;
        mAdapter = adapter;
